        ...
        <div className="row align-items-center justify-content-center">
          <div className="col-lg-6 col-md-9">
            <div className="testimonial-img">
              <img src="/img/images/testimonial_img.jpg" alt="Testimonial Image" />
          ...
          <div className="col-lg-6">
            <div className="testimonial-content">
              <div className="section-title title-style-two mb-50">
                ...
                <h2 className="title">
                  Discover What <span>Clients</span> Have to Say About Me
                </h2>
              </div>
              ...
              <div className="testimonial-item-five">
                <div className="testimonial-info">
                  <div className="thumb">
                    <img src="/img/images/testimonial_avatar01.png" alt="Testimonial Avatar" />
                  </div>
                ...
                <div className="testimonial-content-five">
                  <p>
                    “We aim to be deeply involved in the design process from the outset, ensuring efficient project management and delivering effective construction solutions.”
                  </p>
                </div>
              </div>
            </div>
