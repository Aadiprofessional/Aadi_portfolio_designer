  ...
  const inner_projects = [
    {
      ...
      desc: "Extensive experience in building decentralized applications using Ethereum and Solidity.",
    },
    {
      url: "/project-details",
      ...
      desc: "Proficient in creating engaging animations and visual effects for web and mobile applications.",
    },
    {
      url: "/project-details",
      ...
      desc: "Hands-on experience in developing responsive and user-friendly mobile applications.",
    },
    {
      url: "/project-details",
      ...
      title: "Web Design",
      desc: "Expertise in designing intuitive and visually appealing user interfaces for websites.",
    },
    {
      url: "/project-details",
      ...
      title: "UI/UX Design",
      desc: "Deep understanding of user-centered design principles and best practices.",
    },
    {
      url: "/project-details",
      src1: "/img/project/inner_two_project08.jpg",
      ...
      desc: "Proficiency in developing blockchain solutions and integrating smart contracts.",
    },
  ];
        ...
        <div className="row align-items-center">
          <div className="col-md-8">
            <div className="section-title title-style-two mb-70">
              ...
              <h2 className="title">
                Demonstrating Expertise in Web3, Animation, and App Development
              </h2>
            </div>
          </div>
