                          ...
                          <ul className="list-wrap">
                            <li>
                              ...
                              <div className="content">
                                <a href="mailto:aadiprofessional8@gmail.com">
                                aadiprofessional8@gmail.com
                                </a>
                              </div>
                            </li>
                            <li>
                              ...
                              <div className="content">
                                <span>
                                  46/IV NCERT CAMPUS ,New Delhi ,INDIA
                                </span>
                              </div>
                            </li>
                            <li>
