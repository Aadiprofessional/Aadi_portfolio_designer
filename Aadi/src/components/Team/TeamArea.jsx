          ...
          <div className="col-lg-6">
            <div className="team-content">
              <div className="section-title mb-25">
                <span className="sub-title">Unleashing Creativity</span>
                <h2 className="title">
                  Empowering Creativity Through Fearless Exploration
                </h2>
              </div>
              <p>
                In our team, we believe that creativity flourishes when individuals
                are unafraid to explore new ideas and embrace failure as an essential
                part of the creative process. Lorem Ipsum is simply dummy text of the
