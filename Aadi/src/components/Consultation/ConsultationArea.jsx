          ...
          <div className="col-lg-7">
            <div className="consultation-content">
              <div className="section-title mb-25">
                ...
                <span className="sub-title">95% Satisfaction Rate</span>
                <h2 className="title">Transform Your Business with Expert Digital Marketing Solutions</h2>
              </div>
              <p>
                Elevate your brand's online presence with our tailored digital marketing strategies. Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.
              </p>
