          ...
          <div className="col-lg-7">
            <div className="consultation-content">
              <div className="section-title mb-25">
                <span className="sub-title">Tailored Digital Marketing Solutions</span>
                <h2 className="title">Transform Your Business with Our Expertise</h2>
              </div>

              <p>
                Elevate your brand's online presence with our tailored digital marketing strategies. Lorem ipsum dolor sit amet, sed nulla ante amet, elementum tincidunt arcu sed laoreet, natoque ac eget imperdiet. Ac scelerisque nibh dolores consectetuer, nulla aptent est pede. Scelerisque euismod varius mi, congue eget sed vestibulum, ornare cras sed nec.
              </p>
